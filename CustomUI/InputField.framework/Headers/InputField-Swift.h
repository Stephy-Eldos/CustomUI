...
#ifndef INPUTFIELD_SWIFT_H
#define INPUTFIELD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="InputField",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC10InputField10InputField")
...
@interface InputField (SWIFT_EXTENSION(InputField)) <UITextFieldDelegate>
